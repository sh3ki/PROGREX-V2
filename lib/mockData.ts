...
export const projects = [
  ...
  },
  {
    ...
    features: ['Spaced-Repetition Flashcards', 'Timed Quiz Mode', 'Mastery Tracking', 'Deck Organization', 'Progress Analytics', 'Offline Study Mode', 'Daily Reminders', 'Dark / Light Theme'],
    technologies: ['Flutter', 'Dart', 'Supabase', 'Supabase Auth', 'Supabase Realtime', 'Supabase Edge Functions', 'fl_chart', 'flutter_local_notifications'],
    results: [
