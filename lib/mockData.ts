...
export const services = [
  {
    ...
    faqs: [
      { q: 'How much does custom software cost?', a: 'Pricing depends on scope and complexity. Simple internal tools typically start at ₱50,000–₱120,000, while full enterprise platforms can range from ₱300,000 to ₱2,000,000+. We provide a detailed project estimate after the discovery phase.' },
      { q: 'How long does a custom project take?', a: 'Timelines vary by complexity — typically 3–12 months for enterprise projects, 4–8 weeks for smaller internal tools.' },
      { q: 'Do you sign NDAs?', a: 'Absolutely. We sign an NDA before any project discussion to protect your idea and business details.' },
      { q: 'Will I own the source code?', a: 'Yes. Upon full payment, all intellectual property and source code belong entirely to you.' },
    ],
  },
  {
    id: 'web-development',
    ...
    faqs: [
      { q: 'How much does a website cost?', a: 'Pricing varies depending on complexity. A simple landing page starts at around ₱15,000–₱40,000, a corporate website with CMS typically runs ₱50,000–₱150,000, and full-featured web applications or SaaS platforms start at ₱200,000 and up. We provide a fixed quote before any work begins.' },
      { q: 'Will the website be mobile-friendly?', a: 'Every site we build is mobile-first and tested thoroughly across phones, tablets, and desktops.' },
      { q: 'Do you provide hosting?', a: 'We can set up and manage hosting on Vercel, AWS, or your preferred provider — included in most project packages.' },
      { q: 'Can you redesign my existing site?', a: 'Yes. We offer full redesigns and UX overhauls while carefully preserving your existing SEO equity.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does a mobile app cost?', a: 'Cost depends heavily on features and platform. A simple cross-platform app typically starts at ₱80,000–₱200,000, while apps with custom backends, real-time features, or complex workflows range from ₱300,000 to ₱1,000,000+. Complexity, integrations, and target platforms are the main cost drivers.' },
      { q: 'Cross-platform or native?', a: 'We recommend cross-platform (React Native/Flutter) for most projects — it delivers near-native performance at a significantly lower cost. Native development is only recommended when platform-specific hardware features are required.' },
      { q: 'Do you handle App Store submissions?', a: 'Yes — we manage the full submission and review process for both the Apple App Store and Google Play Store.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does system integration cost?', a: 'Pricing depends on the number of systems and the complexity of data flows. Simple two-system integrations typically start at ₱30,000–₱80,000, while multi-platform enterprise integrations commonly range from ₱150,000 to ₱500,000+. We assess your current systems and provide a scoped estimate after audit.' },
      { q: 'Can you integrate legacy systems?', a: 'Yes, we specialize in bridging modern cloud platforms with legacy on-premise software using adapters, middleware, and protocol translation layers.' },
      { q: 'What about data security?', a: 'All integrations are secured with OAuth 2.0, API key management, TLS encryption, and strict role-based access on every data channel.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does a capstone system cost?', a: 'Pricing depends on the system type and complexity. Basic single-module systems start at ₱8,000–₱15,000, while multi-module systems with mobile apps or advanced features typically range from ₱20,000 to ₱45,000+. Rush delivery and full documentation are available for all tiers.' },
      { q: 'Is this plagiarism?', a: 'No. Every system is custom-built from scratch based on your thesis topic and requirements. We also walk you through the system so you fully understand and can confidently present it to your panel.' },
      { q: 'How fast can you deliver?', a: 'Rush delivery is available. Most capstone systems are completed within 2–4 weeks, depending on scope and your submission deadline.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does IT consulting cost?', a: 'Consulting is available on a day-rate or project basis. Day rates typically range from ₱5,000–₱20,000 depending on the engagement. Project-based consulting — such as cloud migration planning or a full IT audit — commonly ranges from ₱40,000 to ₱200,000+, depending on scope and infrastructure size.' },
      { q: 'Do you offer cloud migration?', a: 'Yes. We plan and execute full cloud migrations to AWS, Azure, or GCP — with minimal downtime and a staged rollback strategy.' },
      { q: 'Can you help with cybersecurity?', a: 'Yes. We offer security audits, threat modeling, penetration testing recommendations, and end-to-end security hardening for your infrastructure.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does hardware/IoT integration cost?', a: 'Cost varies widely based on the number of devices, protocols, and dashboard complexity. A basic IoT integration project typically starts at ₱50,000–₱150,000, while full industrial fleet setups with custom dashboards and cloud pipelines commonly range from ₱250,000 to ₱700,000+, depending on scale and requirements.' },
      { q: 'Do you work with existing hardware?', a: 'Yes. We integrate with virtually any hardware that supports standard communication protocols such as MQTT, HTTP, Modbus, BLE, or LoRaWAN.' },
      { q: 'Can you build the physical device too?', a: 'We partner with trusted hardware engineers and electronics prototyping firms for full custom device design and manufacturing when needed.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does an AI/ML project cost?', a: 'Pricing depends on model complexity, data availability, and deployment requirements. A basic AI feature or chatbot typically starts at ₱80,000–₱200,000. Custom-trained models with full MLOps pipelines for enterprise use commonly range from ₱350,000 to ₱1,200,000+. We scope each project after an initial data and requirements assessment.' },
      { q: 'Do we need a large dataset?', a: 'Not always. We leverage pre-trained models, transfer learning, and data augmentation techniques to deliver strong results even with limited data — depending on the use case.' },
      { q: 'Can you build a chatbot trained on our data?', a: 'Yes. We build RAG-based chatbots and fine-tuned LLM applications powered by your own documents, knowledge base, or internal data.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does business automation cost?', a: 'Cost depends on the number of workflows, tools involved, and volume of transactions. A single automated workflow typically starts at ₱25,000–₱70,000. Full-suite automation across multiple departments commonly ranges from ₱120,000 to ₱500,000+, depending on complexity and integrations required.' },
      { q: 'Which processes are best for automation?', a: 'Repetitive, rule-based, high-volume tasks with predictable inputs and outputs are ideal — such as data entry, report generation, invoicing, approvals, and notifications.' },
      { q: 'Will automation break my existing systems?', a: 'No. We design all automation non-invasively — hooking into your existing software via APIs and webhooks without touching or modifying core systems.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does deployment and DevOps setup cost?', a: 'Pricing depends on stack complexity and cloud provider. A straightforward cloud setup with CI/CD pipeline typically starts at ₱20,000–₱60,000. Full containerized deployments with Kubernetes, monitoring, and multi-environment pipelines commonly range from ₱80,000 to ₱250,000+, depending on scale and requirements.' },
      { q: 'Which cloud provider do you recommend?', a: 'It depends on your needs, team familiarity, and budget — we work with AWS, GCP, and Azure and make recommendations based on your specific scale, cost targets, and existing stack.' },
      { q: 'Can you manage our existing deployment?', a: 'Yes. We offer managed DevOps retainer services including ongoing CI/CD pipeline management, infrastructure cost optimization, and incident response.' },
    ],
  },
  {
    id: 'ui-ux-design',
    ...
    faqs: [
      { q: 'How much does UI/UX design cost?', a: 'Pricing depends on the scope and deliverables. Wireframes and basic prototypes typically start at ₱15,000–₱40,000. A full design engagement — including user research, high-fidelity UI, interactive prototypes, and a design system — commonly ranges from ₱60,000 to ₱200,000+, depending on complexity and number of screens.' },
      { q: 'Do you offer design-only engagements?', a: 'Yes. We provide UI/UX design as a fully standalone service — no development required — delivering Figma files, design tokens, and developer-ready component specs.' },
      { q: 'Will you design for both web and mobile?', a: 'Absolutely. We design responsive web interfaces and native mobile UIs simultaneously within a single unified design system, ensuring consistency across all platforms.' },
    ],
  },
  {
    ...
    faqs: [
      { q: 'How much does a cybersecurity audit cost?', a: 'Pricing depends on the scope and depth of the engagement. A focused vulnerability assessment for a web application typically starts at ₱30,000–₱80,000. A comprehensive penetration test with compliance review and full remediation support commonly ranges from ₱120,000 to ₱350,000+, depending on system complexity and regulatory requirements.' },
      { q: 'How do you handle discovered vulnerabilities?', a: 'We provide a detailed report with severity ratings (Critical/High/Medium/Low), reproduction steps, and clear recommended fixes — then work with your team through full remediation until risks are resolved.' },
      { q: 'Do you offer ongoing security monitoring?', a: 'Yes. We offer retainer-based continuous security monitoring, quarterly penetration test cycles, and dedicated incident response support for businesses that need ongoing protection.' },
    ],
  },
]
...
// ─── PROJECT CATEGORIES ───────────────────────────────────────────────────────
export const projectCategories = ['All', 'Web', 'Mobile', 'Enterprise', 'Academic', 'SaaS', 'E-commerce', 'Hardware']
